...
export const BottomNav: React.FC<BottomNavProps> = ({ activePage, userRole, onNavigate }) => {
 ...
 return (
 <nav className="fixed bottom-0 w-full max-w-md bg-white border-t border-slate-100 pb-safe z-50 shadow-sm">
 ...
 {isActive && (
 <div className="absolute -bottom-2 w-1 h-1 bg-primary rounded-full shadow-sm" />
 )}
 </button>
 );
 })}
