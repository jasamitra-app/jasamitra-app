...
export const DISTRICTS: Record<string, string[]> = {
  "Kota Bandung": ["Andir", "Astana Anyar", "Antapani", "Arcamanik", "Babakan Ciparay", "Bandung Kidul", "Bandung Kulon", "Bandung Wetan", "Batununggal", "Bojongloa Kaler", "Bojongloa Kidul", "Buahbatu", "Cibeunying Kaler", "Cibeunying Kidul", "Cibiru", "Cicendo", "Cidadap", "Cinambo", "Coblong", "Gedebage", "Kiaracondong", "Lengkong", "Mandalajati", "Panyileukan", "Rancasari", "Regol", "Sukajadi", "Sukasari", "Sumur Bandung", "Ujung Berung"],
  "Kab. Bandung": ["Soreang", "Banjaran", "Ciwidey", "Pangalengan", "Ciparay", "Majalaya", "Rancaekek", "Cileunyi", "Bojongsoang", "Dayeuhkolot", "Arjasari", "Baleendah", "Cangkuang", "Cicalengka", "Cikancung", "Cilengkrang", "Cimaung", "Cimenyan", "Ibun", "Katapang", "Kertasari", "Kutawaringin", "Margaasih", "Margahayu", "Nagreg", "Pacet", "Pameungpeuk", "Pasirjambu", "Solokanjeruk"],
  "Kab. Bandung Barat (KBB)": ["Ngamprah", "Padalarang", "Lembang", "Parongpong", "Cisarua", "Batujajar", "Cililin", "Cikalongwetan", "Cipatat", "Cipeundeuy", "Cipongkor", "Cisat", "Gununghalu", "Rongga", "Sindangkerta"],
