          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[4000] flex items-end justify-center bg-slate-900/60 backdrop-blur-sm">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                {(adCategory === 'pengelasan' || adCategory === 'bangunan') && (
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-2">Harga Material (Wajib untuk kategori ini)</label>
                    <input 
                      type="text" 
                      value={materialPrice}
                ...
                <div className="pt-4 space-y-3">
                  <button 
                    ...
                    onClick={async () => {
                      ...
                      if ((adCategory === 'pengelasan' || adCategory === 'bangunan') && (materialPrice === '' || isNaN(Number(materialPrice.toString().replace(/[^0-9]/g, ''))))) {
                        alert('Mohon isi harga material dengan angka untuk kategori ini');
                        return;
                      }
                      ...
                      try {
                        ...
                        const cleanMaterialPrice = (adCategory === 'pengelasan' || adCategory === 'bangunan') 
                          ? Number(materialPrice.toString().replace(/[^0-9]/g, '')) 
                          : 0;
                        ...
                        await addDoc(collection(db, 'iklan'), {
                          ...
                          category: adCategory,
                          price: cleanPrice,
                          materialPrice: cleanMaterialPrice,
                          desc: adDesc,
                          province: adProvince,
                          city: adCity,
                          district: adDistrict,
