...
const OnboardingScreen = ({ onSelect }: { onSelect: (role: 'tamu' | 'mitra') => void }) => {
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 z-[9998] bg-primary text-white flex flex-col px-8 py-12"
    >
      <div className="flex-1 flex flex-col justify-center">
        ...
        <div className="mt-12 space-y-4">
          <motion.button
            ...
            className="w-full bg-white text-slate-900 p-6 rounded-[32px] flex items-center gap-5 shadow-2xl group transition-all hover:bg-accent hover:text-slate-900"
          >
            <div className="w-14 h-14 bg-slate-100 rounded-2xl flex items-center justify-center text-slate-900 group-hover:bg-white/20 group-hover:text-slate-900 transition-colors">
              <User size={28} />
            </div>
      ...
      >
        <p className="text-[10px] text-white/60 font-bold uppercase tracking-widest">
          ...
          <span className="text-white">Syarat & Ketentuan</span> kami
        </p>
      </motion.div>
    </motion.div>
  );
...
export default function App() {
  ...
  return (
    <div className="min-h-screen pb-24">
          ...
          >
            ...
            <main className="px-6 -mt-6 relative z-20 pb-32">
              ...
              <motion.div 
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                className="bg-white p-6 rounded-[32px] shadow-premium border border-slate-100 flex gap-5 mb-10 relative overflow-hidden group"
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-accent/10 rounded-full -mr-12 -mt-12 transition-transform group-hover:scale-110" />
                <div className="w-14 h-14 bg-primary rounded-2xl flex items-center justify-center text-white shadow-lg shadow-primary/20 shrink-0 relative z-10">
                  <ShieldCheck size={28} />
                </div>
                <div className="relative z-10">
                  <h4 className="text-xs font-black text-slate-800 uppercase tracking-wider mb-1.5 flex items-center gap-2">
                    Jaminan Keamanan <span className="text-primary">Verified</span>
                  </h4>
                  <p className="text-[10px] text-slate-500 leading-relaxed font-medium">
                    Seluruh mitra JasaMitra telah melewati verifikasi ketat (KTP, SKCK, Rekening) untuk menjamin keamanan & profesionalisme di setiap pekerjaan.
                  </p>
                </div>
              </motion.div>
          ...
          >
            ...
            <main className="px-6 -mt-4">
              ...
              <div className="bg-white rounded-[40px] shadow-sm border border-slate-100 overflow-hidden mb-8">
                {[
                  { id: 'peraturan-pelanggan', label: 'Peraturan Pelanggan', icon: Info, color: 'text-primary', bg: 'bg-primary/10', show: userRole === 'tamu' },
                  ...
                  { id: 'pesanan', label: 'Pesanan Masuk (Mitra)', icon: Handshake, color: 'text-primary', bg: 'bg-primary/10', show: isMitra },
              ...
              <div className="bg-white p-6 rounded-[40px] shadow-sm border border-slate-100 space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-accent/10 p-6 rounded-3xl border border-accent/20 space-y-4">
                    <h4 className="text-[10px] font-bold text-accent uppercase tracking-wider flex items-center gap-2"><AlertTriangle size={16} /> Peraturan & Kode Etik</h4>
                    <ul className="text-[10px] text-accent font-medium space-y-3 list-disc ml-4">
                      <li>
                    ...
                    <label className="flex items-start gap-3 text-[11px] text-accent font-medium cursor-pointer bg-accent/10 p-4 rounded-xl border-l-[3px] border-accent mt-4">
                      <input type="checkbox" className="mt-0.5 w-4 h-4 accent-accent" />
                      <span>
            ...
            <main className="px-6 -mt-4 pb-12">
              <div className="bg-slate-50 rounded-[30px] p-4 overflow-y-auto max-h-[75vh] hide-scrollbar">
                ...
                <div className="bg-white rounded-[30px] p-6 shadow-sm border border-slate-100 space-y-8">
                  ...
                  <div id="jaminan" className="scroll-mt-20 bg-primary/10 rounded-3xl p-6 border-l-4 border-primary">
                    ...
                    <div className="bg-white rounded-2xl p-5 space-y-6 shadow-sm border border-primary/20">
                      <div className="flex gap-4">
                    ...
                    <div className="bg-accent/10 border-l-4 border-accent p-4 rounded-2xl mt-6">
                      <p className="text-[11px] text-accent font-bold flex items-center gap-2">
      ...
      <AnimatePresence>
        {showAdModal && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[4000] flex items-end justify-center bg-primary/60 backdrop-blur-sm">
            <motion.div 
              initial={{ y: '100%' }}
              animate={{ y: 0 }}
              exit={{ y: '100%' }}
        ...
        {showDealModal && activeDeal && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[4000] flex items-center justify-center bg-primary/90 backdrop-blur-xl p-6">
            <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 20 }} className="bg-white w-full max-w-sm rounded-[48px] p-8 shadow-2xl overflow-hidden relative border border-white/20">
              ...
              <div className="bg-primary p-6 rounded-[32px] mb-8 text-white shadow-xl shadow-primary/20 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <p className="text-[9px] font-black text-white/60 uppercase tracking-[0.2em] mb-3">Metode Transfer Bank</p>
                  <div className="flex items-center justify-between mb-1">
                    <p className="text-xl font-black tracking-wider">8123 4567 89</p>
                    <div className="bg-white/20 px-2 py-1 rounded-lg text-[10px] font-black">BCA</div>
                  </div>
                  <p className="text-[10px] font-bold text-white/80">a.n. PT JasaMitra Indonesia</p>
                </div>
              </div>
        ...
        {bookingService && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[3000] flex items-end justify-center bg-primary/60 backdrop-blur-sm p-4"
          >
            <motion.div 
              initial={{ y: 100 }}
              animate={{ y: 0 }}
