...
export default function App() {
  ...
  const [myAds, setMyAds] = useState([
    { id: 1, title: 'Servis AC Panggilan', cat: 'Elektronik', price: 'Rp 150.000 - 300.000', status: 'aktif', img: 'https://images.unsplash.com/photo-1585333120117-0626bc968a33?w=100' },
    { id: 2, title: 'Instalasi Listrik', cat: 'Instalasi', price: 'Rp 200.000 - 500.000', status: 'aktif', img: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=100' },
    { id: 3, title: 'Cuci Sofa', cat: 'Cleaning', price: 'Rp 250.000 - 400.000', status: 'nonaktif', img: 'https://images.unsplash.com/photo-1550581190-9c1c48d21d6c?w=100' },
  ]);
  ...
  const confirmDeal = () => {
    ...
    setMitraOrders([newMitraOrder, ...mitraOrders]);
